...
var server = http.createServer(function(request, response) {
  // Not important for us. We're developing a WebSocket server, not HTTP server
});
...
wsServer.on('request', function(request) {
  ...
  // user sent some message received Event message and handling at EventHandler onMessage
